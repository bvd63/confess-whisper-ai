  ...
  - dialog:
    ...
    - generic:
      ...
      - generic:
        - generic:
          - generic:
            - heading [level=3]: Current Status
            - paragraph: VIP - Monthly
            - paragraph: "Next billing: {date}: 11/12/2025"
          - generic: Active
      - generic:
        - tablist:
    ...
    - button:
      - img
      - generic: Close
  - alertdialog "Cancel Subscription" [ref=e37]:
    - generic [ref=e38]:
      - heading "Cancel Subscription" [level=2] [ref=e39]
      - paragraph [ref=e40]: Your subscription will remain active until 11/12/2025, then you'll return to the Free plan.
    - generic [ref=e41]:
      - button "Close" [active] [ref=e42] [cursor=pointer]
      - button "Success" [ref=e43] [cursor=pointer]
```