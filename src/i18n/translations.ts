...
type Translations = {
  ...
  auth_captcha_verify_prompt: string;
  auth_reset_rate_limited: string;
...
export const translations: Record<Language, Translations> = {
  ...
  required: "Required",
    ...
    vip_benefits: "Unlimited Deep Insights, detailed responses.",
    ...
    profile_total_confessions: "Confessions",
    profile_total_likes: "Reactions",
    profile_total_comments: "Comments",
  ...
  confession_deleted: "Confession was deleted",
    ...
    auth_captcha_required: "For security reasons, please verify you're human.",
  ...
  auth_forgot_password_success: "If an account exists with this email, you’ll receive a reset link shortly.",
  ...
  auth_reset_password_success: "Your password has been updated successfully.",
  ...
  common_close: "Close",
    ...
    profile_vip_description: "Get unlimited access to Deep Insights AI and extended responses.",
  ...
  communities_empty_description: "Create a community and connect with others who share your interests!",
    ...
    faq_a1: "Yes. Confessions stay anonymous—your name never shows and other users cannot link posts back to you. We keep only the minimal data required to run the app.",
    faq_q2: "How does the AI work?",
    faq_a2: "AI reviews your confession and creates a fresh empathetic reply each time using models tuned for supportive, judgment-free language.",
    faq_q3: "What is Deep Insight?",
    faq_a3: "Deep Insight is a VIP add-on that delivers deeper analysis, practical tips, and reflective prompts so you can better understand your situation.",
    faq_q4: "Can I delete my confessions?",
    faq_a4: "You can edit or delete any confession from your profile. Deleted entries are removed permanently from our systems.",
    faq_q5: "What does the VIP subscription offer?",
    faq_a5: "VIP unlocks unlimited Deep Insights, richer replies, priority processing, and helps fund future improvements.",
    faq_q6: "How does the referral program work?",
    faq_a6: "Share your referral code with friends. When they join with your link, both of you earn rewards—details live on your profile.",
    faq_q7: "Is my data secure?",
    faq_a7: "Yes. Data is encrypted, stored securely, and handled under GDPR-style safeguards. We never sell or share it.",
    faq_q8: "Can I use the platform for professional counseling?",
    faq_a8: "No. Confess+ is not professional therapy. Please contact a licensed expert for urgent mental health support.",
    faq_q9: "What makes the AI empathetic?",
    faq_a9: "The AI is trained on empathetic conversations and advanced language models that focus on supportive, judgment-free replies tailored to you.",
    faq_q10: "How anonymous am I really?",
    faq_a10: "Your identity stays private. Other users cannot link confessions to you and we only retain the essentials needed for the service.",
    faq_q11: "What are Deep Insights?",
    faq_a11: "Deep Insights are VIP-only breakdowns with extra context, actionable advice, and prompts for deeper reflection.",
    faq_q12: "How fast are the AI responses?",
    faq_a12: "Replies appear seconds after you post. VIP members also get priority queues during busy hours.",
  ...
  payment_view_profile: "View Your VIP Profile",
    ...
    onboarding_welcome_desc: "Share freely, connect safely, and stay anonymous",
    onboarding_privacy_title: "Privacy First",
    onboarding_privacy_desc: "End-to-end protections keep your confessions anonymous unless you opt in.",
    onboarding_terms_desc: "By continuing you accept our Terms & Privacy Policy. Remove your data anytime in settings.",
    ...
    support_ai_initial_message: "Hi! I'm the ConfessAI bot. Ask me about login issues, VIP, coins, confessions, notifications, or bugs. For urgent billing or access help, email confess.supp@gmail.com.",
    ...
    support_email_body: "Hello ConfessAI support,\n\nAccount email:\nIssue:\nDetails:\n\nThanks!",
    contact_support_title: "Contact Support",
    contact_support_description: "Tell us about any app issue.",
    contact_support_name_label: "Name",
    contact_support_email_label: "Email",
    contact_support_issue_label: "Issue details",
    contact_support_button: "Submit",
    contact_support_button_sending: "Sending...",
    contact_support_email_footer: "Sent via ConfessAI.",
    contact_support_success_title: "Message received",
    contact_support_success_body: "We'll respond within 24 hours.",
    ...
    contact_support_success_toast_title: "Request sent",
    contact_support_success_toast_body: "Thanks! We'll email you soon.",
    ...
    confirm: {
      ...
      boostConfession: {
        ...
        message: "Are you sure you want to boost this confession for 24 hours for 25 coins?",
      },
      generic: {
        title: "Are you sure?",
  ...
  required: "Requerido",
    ...
    vip_benefits: "Deep Insights ilimitados, respuestas detalladas.",
    ...
    auth_invalid_email: "Por favor ingresa una dirección de correo válida.",
    ...
    auth_captcha_required: "Por razones de seguridad, verifica que eres humano.",
    ...
    auth_captcha_verify_prompt: "Por seguridad, verifica que eres humano.",
    ...
    auth_forgot_password_success: "Si existe una cuenta con este correo, recibirás un enlace de restablecimiento en breve.",
    ...
    auth_reset_password_success: "Tu contraseña se ha actualizado correctamente.",
    ...
    auth_reset_rate_limited: "Has solicitado demasiados enlaces de restablecimiento. Inténtalo de nuevo más tarde.",
    ...
    profile_vip_description: "Obtén acceso ilimitado a Deep Insights IA y respuestas extendidas.",
  ...
  communities_empty_description: "¡Crea una comunidad y conecta con otros que comparten tus intereses!",
    ...
    faq_a1: "Sí. Las confesiones permanecen anónimas; tu nombre no se muestra y nadie puede vincular los posts contigo. Solo guardamos lo mínimo para operar la app.",
    faq_q2: "¿Cómo funciona la IA?",
    faq_a2: "La IA revisa tu confesión y genera cada vez una respuesta empática usando modelos entrenados para lenguaje comprensivo y sin juicios.",
    faq_q3: "¿Qué es Deep Insight?",
    faq_a3: "Deep Insight es un extra VIP con análisis más profundos, consejos prácticos y preguntas reflexivas para entender mejor tu situación.",
    faq_q4: "¿Puedo eliminar mis confesiones?",
    faq_a4: "Puedes editar o borrar cualquier confesión desde tu perfil. Las eliminadas se borran definitivamente.",
    faq_q5: "¿Qué ofrece la suscripción VIP?",
    faq_a5: "VIP desbloquea Deep Insights ilimitados, respuestas más ricas, prioridad de proceso y apoya futuras mejoras.",
    faq_q6: "¿Cómo funciona el programa de referidos?",
    faq_a6: "Comparte tu código de referido. Cuando alguien se registra con tu enlace, ambos reciben recompensas; consulta los detalles en tu perfil.",
    faq_q7: "¿Mis datos están seguros?",
    faq_a7: "Sí. Los datos se cifran, se almacenan con seguridad y cumplimos normas estilo GDPR. Nunca los vendemos ni compartimos.",
    faq_q8: "¿Puedo usar la plataforma para asesoramiento profesional?",
    faq_a8: "No. Confess+ no reemplaza la terapia profesional. Para temas urgentes contacta a un especialista.",
    faq_q9: "¿Qué hace empática a la IA?",
    faq_a9: "La IA está entrenada en conversaciones empáticas y modelos avanzados que entregan respuestas personalizadas sin juicios.",
    faq_q10: "¿Qué tan anónimo soy realmente?",
    faq_a10: "Tu identidad se mantiene privada. Nadie puede vincular confesiones contigo y solo conservamos lo esencial para el servicio.",
    faq_q11: "¿Qué son los Deep Insights?",
    faq_a11: "Los Deep Insights VIP ofrecen contexto adicional, consejos accionables y preguntas para una reflexión más profunda.",
    faq_q12: "¿Qué tan rápidas son las respuestas de la IA?",
    faq_a12: "Las respuestas llegan en segundos. Los miembros VIP tienen prioridad en horas pico.",
  ...
  settings_sessions_expires_soon: "Expira pronto",
    ...
    profile_total_confessions: "Confesiones",
    profile_total_likes: "Reacciones",
    profile_total_comments: "Comentarios",
  ...
  subscription_manage_billing: "Gestionar facturación",
    ...
    profile_bio_placeholder: "Añade una bio…",
    ...
    onboarding_welcome_desc: "Comparte libremente, conéctate seguro y mantente anónimo",
    onboarding_privacy_title: "Privacidad Primero",
    onboarding_privacy_desc: "El cifrado mantiene tus confesiones anónimas salvo que tú lo cambies.",
    onboarding_terms_desc: "Al seguir aceptas nuestros Términos y Privacidad. Borra tus datos cuando quieras en ajustes.",
    ...
    support_ai_initial_message: "¡Hola! Soy el bot de soporte ConfessAI. Pregunta por inicio de sesión, VIP, coins, confesiones, notificaciones o errores. Para asuntos urgentes de facturación o acceso escribe a confess.supp@gmail.com.",
    ...
    support_email_body: "Hola soporte de ConfessAI,\n\nCorreo de la cuenta:\nProblema:\nDetalles:\n\n¡Gracias!",
    contact_support_title: "Contactar con soporte",
    contact_support_description: "Cuéntanos cualquier problema de la app.",
    ...
    contact_support_button: "Enviar",
    contact_support_button_sending: "Enviando...",
    contact_support_email_footer: "Enviado desde ConfessAI.",
    contact_support_success_title: "Mensaje recibido",
    contact_support_success_body: "Responderemos en menos de 24 horas.",
    ...
    contact_support_success_toast_body: "Gracias, te escribiremos pronto.",
    ...
    confirm: {
      ...
      boostConfession: {
        ...
        message: "¿Seguro que quieres impulsar esta confesión durante 24 horas por 25 monedas?",
      },
      generic: {
        title: "¿Estás seguro?",
  ...
  de: {
    ...
    popular_confessions: "Beliebte Geständnisse 🔥",
  ...
  required: "Erforderlich",
    ...
    vip_benefits: "Unbegrenzte Deep Insights, detaillierte Antworten.",
    ...
    comments_empty: "Noch keine Kommentare. Sei der Erste, der kommentiert.",
    ...
    auth_captcha_required: "Aus Sicherheitsgründen bestätige bitte, dass du ein Mensch bist.",
    ...
    auth_forgot_password_success: "Wenn ein Konto mit dieser E-Mail existiert, erhältst du in Kürze einen Zurücksetz-Link.",
    ...
    auth_reset_password_success: "Dein Passwort wurde erfolgreich aktualisiert.",
    ...
    auth_reset_rate_limited: "Du hast zu viele Zurücksetz-Links angefordert. Bitte versuche es später erneut.",
    ...
    profile_vip_description: "Erhalte unbegrenzten Zugang zu Deep Insights KI und erweiterten Antworten.",
  ...
  communities_empty_description: "Erstelle eine Community und verbinde dich mit anderen, die deine Interessen teilen!",
    ...
    faq_a1: "Ja. Deine Geständnisse bleiben anonym; dein Name erscheint nicht und niemand kann Beiträge mit dir verknüpfen. Wir speichern nur das Nötigste für den Betrieb.",
    faq_q2: "Wie funktioniert die KI?",
    faq_a2: "Die KI liest dein Geständnis und erstellt jedes Mal eine neue empathische Antwort mit Modellen für unterstützende, urteilsfreie Sprache.",
    faq_q3: "Was ist Deep Insight?",
    faq_a3: "Deep Insight ist ein VIP-Add-on mit tieferer Analyse, praktischen Tipps und Reflexionsfragen.",
    faq_q4: "Kann ich meine Geständnisse löschen?",
    faq_a4: "Du kannst jedes Geständnis im Profil bearbeiten oder löschen. Gelöschte Einträge verschwinden dauerhaft.",
    faq_q5: "Was bietet das VIP-Abonnement?",
    faq_a5: "VIP schaltet unbegrenzte Deep Insights, ausführlichere Antworten, Priorität und zukünftige Verbesserungen frei.",
    faq_q6: "Wie funktioniert das Empfehlungsprogramm?",
    faq_a6: "Teile deinen Empfehlungscode. Wenn Freunde über deinen Link beitreten, erhalten alle Belohnungen – Details stehen im Profil.",
    faq_q7: "Sind meine Daten sicher?",
    faq_a7: "Ja. Daten werden verschlüsselt, sicher gespeichert und gemäß DSGVO-Standards behandelt. Wir verkaufen oder teilen sie nie.",
    faq_q8: "Kann ich die Plattform für professionelle Beratung nutzen?",
    faq_a8: "Nein. Confess+ ersetzt keine professionelle Therapie. Bitte wende dich bei dringenden Themen an Fachleute.",
    faq_q9: "Was macht die KI empathisch?",
    faq_a9: "Die KI basiert auf empathischen Dialogen und modernen Sprachmodellen, die unterstützende, urteilsfreie Antworten für dich erstellen.",
    faq_q10: "Wie anonym bin ich wirklich?",
    faq_a10: "Deine Identität bleibt privat. Andere können Geständnisse nicht dir zuordnen und wir behalten nur das Nötigste für den Dienst.",
    faq_q11: "Was sind Deep Insights?",
    faq_a11: "Deep Insights sind VIP-Analysen mit zusätzlichem Kontext, konkreten Tipps und Reflexionsimpulsen.",
    faq_q12: "Wie schnell sind die KI-Antworten?",
    faq_a12: "Antworten erscheinen in Sekunden. VIP-Mitglieder genießen Priorität zu Stoßzeiten.",
  ...
  settings_sessions_expires_soon: "Läuft bald ab",
    ...
    profile_total_confessions: "Geständnisse",
    profile_total_likes: "Reaktionen",
    profile_total_comments: "Kommentare",
  ...
  subscription_manage_billing: "Abrechnung verwalten",
    ...
    profile_bio_placeholder: "Füge eine Bio hinzu…",
    ...
    onboarding_welcome_desc: "Teile frei, vernetze dich sicher und bleibe anonym",
    onboarding_privacy_title: "Privatsphäre zuerst",
    onboarding_privacy_desc: "Ende-zu-Ende-Schutz hält deine Geständnisse anonym, bis du etwas anderes wählst.",
    onboarding_terms_desc: "Mit Weiter bestätigst du unsere Nutzungsbedingungen & Datenschutzerklärung. Lösche deine Daten jederzeit in den Einstellungen.",
    ...
    support_ai_initial_message: "Hallo! Ich bin der ConfessAI Bot. Frag mich zu Login, VIP, Coins, Geständnissen, Benachrichtigungen oder Bugs. Bei dringender Abrechnung oder Zugriff schreibe an confess.supp@gmail.com.",
    ...
    support_email_body: "Hallo ConfessAI Support,\n\nAccount-E-Mail:\nProblem:\nDetails:\n\nDanke!",
    contact_support_title: "Support kontaktieren",
    contact_support_description: "Melde jedes App-Problem.",
    contact_support_name_label: "Name",
    contact_support_email_label: "E-Mail",
    contact_support_issue_label: "Problemdetails",
    contact_support_button: "Senden",
    contact_support_button_sending: "Wird gesendet...",
    contact_support_email_footer: "Gesendet aus ConfessAI.",
    contact_support_success_title: "Nachricht erhalten",
    contact_support_success_body: "Wir melden uns innerhalb von 24 Stunden.",
    ...
    contact_support_success_toast_title: "Anfrage gesendet",
    ...
    confirm: {
      ...
      boostConfession: {
        ...
        message: "Bist du sicher, dass du diese Beichte für 24 Stunden für 25 Coins boosten möchtest?",
      },
      generic: {
