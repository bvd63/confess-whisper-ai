...
const messages: Record<Language, ToastMessages> = {
  en: {
    ...
    vipActivated: "VIP access activated! Enjoy VIP features ✨",
  ...
  es: {
    ...
    vipActivated: "¡Acceso VIP activado! Disfruta de las funciones VIP ✨",
  ...
  de: {
    ...
    vipActivated: "VIP-Zugang aktiviert! Genieße VIP-Funktionen ✨",
