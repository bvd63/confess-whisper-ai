...
>(({ className, thumbClassName, ...props }, ref) => {
  return (
    <SwitchPrimitives.Root
      ref={ref}
      className={cn(
        "inline-flex h-[18px] w-[36px] items-center rounded-full border-0 bg-white/20",
    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          "pointer-events-none h-[14px] w-[14px] rounded-full bg-white shadow-sm transition-transform",
