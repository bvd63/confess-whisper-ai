  ...
  return (
    <NoScreenshotMode enabled={noScreenshotEnabled}>
      <div className="mx-auto w-full max-w-[520px] px-4 sm:px-6">
        <Card className="relative w-full overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#2a2e5c] via-[#19192f] to-[#0d0d1b] p-5 sm:p-6 space-y-5 shadow-[0_20px_50px_rgba(0,0,0,0.45)]">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 text-sm font-semibold text-white">
                ...
                {isBoosted && (
                  <span className="ml-auto inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-amber-400/90 via-amber-500 to-orange-500 text-[12px] font-semibold text-black shadow-lg border border-amber-200/70">
