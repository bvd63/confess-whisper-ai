    ...
    ? createPortal(
        <nav 
          ...
          style={{
            ...
            background: 'linear-gradient(to bottom right, rgba(26, 26, 46, 0.85), rgba(22, 33, 62, 0.85), rgba(15, 20, 25, 0.85))',
          }}
        >
          <div 
            ref={navRef} 
            className="flex items-center justify-around h-16 w-full px-4 backdrop-blur-xl border-t border-white/5" 
            role="tablist"
          >
