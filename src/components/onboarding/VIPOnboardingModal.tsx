...
const translations: Record<string, OnboardingTranslations> = {
  en: {
    ...
    successDesc: "Your 7-day free trial is now active. Enjoy all premium features!",
  ...
  es: {
    ...
    successDesc: "Tu prueba gratuita de 7 días está activa. ¡Disfruta de todas las funciones premium!",
  ...
  de: {
    ...
    successDesc: "Deine 7-Tage-Testversion ist jetzt aktiv. Genieße alle Premium-Funktionen!",
