        ...
        <div className="space-y-4 py-4">
          ...
          <div className="pt-4">
            <EnhancedButton
              ...
              className="w-full h-14 rounded-full font-semibold text-base text-white bg-gradient-to-r from-purple-600 via-purple-500 to-blue-600 hover:from-purple-700 hover:via-purple-600 hover:to-blue-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-300 shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40"
              glow
              shine
              lift
            >
