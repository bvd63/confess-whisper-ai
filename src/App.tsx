...
const loadAdminTools = () => import("./chunks/admin-tools");
const Admin = lazy(() => loadAdminTools().then((module) => ({ default: module.Admin })));
...
const Performance = lazy(() => loadAdminTools().then((module) => ({ default: module.Performance })));
