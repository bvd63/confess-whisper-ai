  ...
  return (
    <>
      <AppLayout onManageSubscription={() => setManageSubDialogOpen(true)}>
        ...
        <div className="container max-w-4xl mx-auto px-4 sm:px-5 pt-[env(safe-area-inset-top)] pb-28 space-y-4 scrollbar-hide">
          {/* Header */}
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <div className="sticky top-14 z-40 py-2 -mx-4 px-4 sm:-mx-5 sm:px-5">
