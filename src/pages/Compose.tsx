        ...
        <div className="space-y-3 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-lg p-3 shadow-[0_18px_60px_rgba(40,22,82,0.45)]">
          ...
          <div className="flex items-center justify-between px-4 py-3 rounded-2xl bg-white/5 border border-white/10 text-white">
            ...
            <button
              ...
              disabled={isSubmitting}
              className={cn(
                "relative inline-flex h-3.5 w-14 shrink-0 cursor-pointer items-center rounded-lg transition-all duration-300",
            ...
            >
              <span
                className={cn(
                  "pointer-events-none block h-2.5 w-2.5 rounded-sm bg-white shadow-lg ring-0 transition-all duration-300",
                  isAnonymous ? "translate-x-10" : "translate-x-1"
                )}
              />
            </button>
          </div>
