...
import { isIOS } from "@/lib/mobile-utils";
...
const AuthLayout = ({ children }: { children: React.ReactNode }) => (
  <div className="h-[100dvh] bg-background flex flex-col px-6 overflow-hidden">
    {/* Title centered halfway between top edge and form */}
...
const Auth = () => {
  ...
  // iOS detection for Apple button
  const showAppleButton = isIOS();

  // Handle Apple Sign In (coming soon)
  const handleAppleComingSoon = () => {
    toast({
      title: t.auth_continue_apple,
      description: t.auth_apple_coming_soon,
    });
  };
      ...
      <AuthLayout>
        ...
        >
          ...
          <form onSubmit={handleAuth} className="space-y-0">
            ...
            <div className="flex flex-col" style={{ paddingTop: 'clamp(16px, 4vh, 40px)', gap: 'clamp(10px, 2vh, 20px)' }}>
