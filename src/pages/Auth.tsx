...
const Auth = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-background flex items-center justify-center px-6 pb-16">
        <div className="max-w-sm w-full flex flex-col items-center">
          {/* Single Compact Form Container */}
            ...
            <form onSubmit={handleSignupSubmit} className="space-y-3">
              ...
              <div className="space-y-1">
                <Input
                  ...
                  className="h-12 rounded-full px-5 text-base bg-muted/50 border-muted-foreground/20 focus:border-primary focus:ring-primary/30"
                  disabled={isLoading}
                  autoComplete="email"
                />
                {errors.email && (
              ...
              <div className="space-y-1">
                <div className="relative">
                  <Input
                    ...
                    className="h-12 rounded-full px-5 pr-11 text-base bg-muted/50 border-muted-foreground/20 focus:border-primary focus:ring-primary/30"
                    disabled={isLoading}
              ...
              <button
                type="submit"
                disabled={isLoading || !isFormValid()}
                className="w-full h-12 rounded-full bg-gradient-to-r from-primary to-accent text-primary-foreground font-semibold text-base shadow-[0_0_30px_hsl(var(--primary)/0.5)] hover:shadow-[0_0_40px_hsl(var(--primary)/0.7)] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
              >
                {isLoading ? (
                  <span className="flex items-center justify-center gap-2">
                    <Loader2 className="w-5 h-5 animate-spin" />
              ...
              <button
                ...
                onClick={handleGoogleSignIn}
                disabled={isLoading}
                className="w-full h-12 rounded-full bg-muted/50 border border-muted-foreground/20 text-foreground font-medium text-base flex items-center justify-center gap-3 hover:bg-muted/70 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                  <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
