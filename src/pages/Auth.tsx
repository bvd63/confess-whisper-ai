        ...
        >
          ...
          <form onSubmit={handleSignupSubmit} className="space-y-1">
            ...
            <div>
              ...
              <p className={cn("text-xs px-3 h-4 leading-4 transition-opacity duration-200", confirmPassword.length > 0 ? "opacity-100" : "opacity-0", passwordsMatch ? "text-emerald-600/90 dark:text-emerald-400/80" : "text-rose-500/90 dark:text-rose-400/90")}>
